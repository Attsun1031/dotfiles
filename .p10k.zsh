# Generated by Powerlevel10k configuration wizard on 2019-10-18 at 16:00 JST.
...
() {
  ...
  vcs+='${${${$(($#VCS_STATUS_LOCAL_BRANCH<=16)):#0}:+${VCS_STATUS_LOCAL_BRANCH//\%/%%}}'
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_CONTENT_EXPANSION='${P9K_CONTENT:0:8}'
